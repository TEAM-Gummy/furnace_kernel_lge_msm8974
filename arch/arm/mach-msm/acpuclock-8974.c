...
static struct pvs_table pvs_v1_lge_factory[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	/* 8974v1 1.7GHz Parts */
	[0][0] = { acpu_freq_tbl_v1_pvs0_lge_factory, sizeof(acpu_freq_tbl_v1_pvs0_lge_factory) },
	[0][1] = { acpu_freq_tbl_v1_pvs1_lge_factory, sizeof(acpu_freq_tbl_v1_pvs1_lge_factory) },
	[0][2] = { acpu_freq_tbl_v1_pvs2_lge_factory, sizeof(acpu_freq_tbl_v1_pvs2_lge_factory) },
	[0][3] = { acpu_freq_tbl_v1_pvs3_lge_factory, sizeof(acpu_freq_tbl_v1_pvs3_lge_factory) },
	[0][4] = { acpu_freq_tbl_v1_pvs4_lge_factory, sizeof(acpu_freq_tbl_v1_pvs4_lge_factory) },
};

static struct pvs_table pvs_v2_lge_factory[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	/* 8974v2 2.0GHz Parts */
	[0][0] = { acpu_freq_tbl_2g_pvs0_lge_factory, sizeof(acpu_freq_tbl_2g_pvs0_lge_factory) },
	[0][1] = { acpu_freq_tbl_2g_pvs1_lge_factory, sizeof(acpu_freq_tbl_2g_pvs1_lge_factory) },
	[0][2] = { acpu_freq_tbl_2g_pvs2_lge_factory, sizeof(acpu_freq_tbl_2g_pvs2_lge_factory) },
	[0][3] = { acpu_freq_tbl_2g_pvs3_lge_factory, sizeof(acpu_freq_tbl_2g_pvs3_lge_factory) },
	[0][4] = { acpu_freq_tbl_2g_pvs4_lge_factory, sizeof(acpu_freq_tbl_2g_pvs4_lge_factory) },
	[0][5] = { acpu_freq_tbl_2g_pvs5_lge_factory, sizeof(acpu_freq_tbl_2g_pvs5_lge_factory) },
	[0][6] = { acpu_freq_tbl_2g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2g_pvs6_lge_factory) },
	[0][7] = { acpu_freq_tbl_2g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2g_pvs6_lge_factory) },

	/* 8974v2 2.3GHz Parts */
	[1][0] = { acpu_freq_tbl_2p3g_pvs0_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs0_lge_factory) },
	[1][1] = { acpu_freq_tbl_2p3g_pvs1_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs1_lge_factory) },
	[1][2] = { acpu_freq_tbl_2p3g_pvs2_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs2_lge_factory) },
	[1][3] = { acpu_freq_tbl_2p3g_pvs3_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs3_lge_factory) },
	[1][4] = { acpu_freq_tbl_2p3g_pvs4_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs4_lge_factory) },
	[1][5] = { acpu_freq_tbl_2p3g_pvs5_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs5_lge_factory) },
	[1][6] = { acpu_freq_tbl_2p3g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs6_lge_factory) },
	[1][7] = { acpu_freq_tbl_2p3g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2p3g_pvs6_lge_factory) },

	/* 8974v2 2.0GHz Parts */
	[2][0] = { acpu_freq_tbl_2p2g_pvs0_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs0_lge_factory) },
	[2][1] = { acpu_freq_tbl_2p2g_pvs1_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs1_lge_factory) },
	[2][2] = { acpu_freq_tbl_2p2g_pvs2_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs2_lge_factory) },
	[2][3] = { acpu_freq_tbl_2p2g_pvs3_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs3_lge_factory) },
	[2][4] = { acpu_freq_tbl_2p2g_pvs4_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs4_lge_factory) },
	[2][5] = { acpu_freq_tbl_2p2g_pvs5_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs5_lge_factory) },
	[2][6] = { acpu_freq_tbl_2p2g_pvs6_lge_factory, sizeof(acpu_freq_tbl_2p2g_pvs6_lge_factory) },
...
static void __init apply_v1_l2_workaround(void)
{
	...
	if(boot_mode == LGE_BOOT_MODE_MINIOS || boot_mode == LGE_BOOT_MODE_FACTORY2 || boot_mode == LGE_BOOT_MODE_PIFBOOT2) {
		for (s = 0; s < NUM_SPEED_BINS; s++)
			for (p = 0; p < NUM_PVS; p++)
				for (l = pvs_v1_lge_factory[s][p].table; l && l->speed.khz; l++)
					l->l2_level = l->l2_level > 5 ? 1 : 0;

		acpuclk_8974_params_lge_factory.l2_freq_tbl = resticted_l2_tbl;
		acpuclk_8974_params_lge_factory.l2_freq_tbl_size = sizeof(resticted_l2_tbl);
	} else {
        for (s = 0; s < NUM_SPEED_BINS; s++)
            for (p = 0; p < NUM_PVS; p++)
...
static int __init acpuclk_8974_probe(struct platform_device *pdev)
{
	...
	if(boot_mode == LGE_BOOT_MODE_MINIOS || boot_mode == LGE_BOOT_MODE_FACTORY2 || boot_mode == LGE_BOOT_MODE_PIFBOOT2) {
		if (SOCINFO_VERSION_MAJOR(socinfo_get_version()) == 1) {
			acpuclk_8974_params_lge_factory.pvs_tables = pvs_v1_lge_factory;
			acpuclk_8974_params_lge_factory.l2_freq_tbl = l2_freq_tbl_v1;
			bus_scale_data.usecase = bw_level_tbl_v1;
			bus_scale_data.num_usecases = ARRAY_SIZE(bw_level_tbl_v1);
			acpuclk_8974_params_lge_factory.l2_freq_tbl_size = sizeof(l2_freq_tbl_v1);
		...
		return acpuclk_krait_init(&pdev->dev, &acpuclk_8974_params_lge_factory);
    } else {
        if (SOCINFO_VERSION_MAJOR(socinfo_get_version()) == 1) {
